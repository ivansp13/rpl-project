	    ...
	    <section id="contact" class="home-section bg-white">
	  	<div class="container">
	  		...
	  		<div class="row">
				...
				<form method="post" action="tombol_selesai_mbu.php" class="form-horizontal" role="form">
				  ...
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
					  <p>Profil<textarea style="width: 100%;height: 500px;" name="alamat" class="form-control" rows="3" placeholder="Tulis Profil Masjid"></textarea></p>
					</div>
				  </div>
				  <div class="form-group">
					<div class="col-md-offset-2 col-md-8">
				  ...
				  <div class="form-group">
				   ...
				   <div class="form-group">
				  <div class="col-md-offset-2 col-md-8">
				      <p>Kode Wilayah<textarea name="kode_wilayah" class="form-control" placeholder="BS03"></textarea></p>
				  </div>
				  </div>
