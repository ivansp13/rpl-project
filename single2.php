	  	...
	  	<div class="container">
			  <div class="row">
				  <div class="col-md-offset-2 col-md-8">
					<div class="section-heading">
					 ...
					 <p>Berikut adalah profil masjid yang ada di Bandung Barat</p>
					</div>
				  </div>
			  </div>
	  		...
	  		<div class="row">
	  			<div class="col-md-offset-1 col-md-10">
					...
					$pilih=mysql_query("SELECT * FROM masjid_bb"); ?>
					...
					<img style = "widht = 100%; height = 100%;" src = "img/masjid/2.jpg" alt = "">
					<h4>Alamat</h4>
